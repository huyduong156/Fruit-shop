            ...
            <div class="container container-default custom-area">
                <div class="row">
                    <div class="col-lg-9 col-12 col-custom widget-mt">
                        <!-- Blog Wrapper Start -->
                        <div class="description-category" style="padding: 10px; border-radius: 3px; border: 1px solid rgb(215, 215, 215); margin-bottom: 5px">
                            {!!readFileText($category->description)['content']!!}
                        </div>
                        <div class="row">
